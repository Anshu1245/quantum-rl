...
# --- Worker Process ---
def compute_similarity(state_matrix, num_qubits):
    diff = state_matrix.reshape((2*num_qubits, 2*num_qubits)) - np.identity(2*num_qubits)
    ...
    while steps < args['MAX_GRAD_STEPS']:
        ...
        if steps % eval_interval == 0 and steps > 0:
            ...
            if success_rate >= success_threshold:
                d += 1
                print(f"Difficulty increased to d={d}.............................. at step {steps}!", flush=True)
